...
-- -----------------------------------------------------
-- Table `roadwiki`.`roadmapshare`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `roadwiki`.`roadmapshare` (
  `pid` INT NOT NULL AUTO_INCREMENT,
  `rmid` INT NOT NULL,
  `uid` INT NOT NULL,
  ...
  PRIMARY KEY (`pid`),
  INDEX `fk_roadmap_has_user_user1_idx` (`uid` ASC) ,
  INDEX `fk_roadmap_has_user_roadmap1_idx` (`rmid` ASC) ,
  CONSTRAINT `fk_roadmap_has_user_roadmap1`
    FOREIGN KEY (`rmid`)
    REFERENCES `roadwiki`.`roadmap` (`rmid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_roadmap_has_user_user1`
    FOREIGN KEY (`uid`)
    REFERENCES `roadwiki`.`user` (`uid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `roadwiki`.`roadmaplikeuser`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `roadwiki`.`roadmaplikeuser` (
  `pid` INT NOT NULL,
  `uid` INT NOT NULL,
  PRIMARY KEY (`pid`, `uid`),
  INDEX `fk_roadmap_has_user_user2_idx` (`uid` ASC) ,
  CONSTRAINT `fk_roadmap_roadmaplikeuser`
    FOREIGN KEY (`pid`)
    REFERENCES `roadwiki`.`roadmapshare` (`pid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_roadmaplikeuser`
    FOREIGN KEY (`uid`)
    REFERENCES `roadwiki`.`user` (`uid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
