...
export default {
  ...
  mounted() {
        ...
        $(go.Node, "Table", this.nodeStyle(),
          ...
          $(go.Panel, "Auto",
            $(go.Shape, "RoundedRectangle",
              { fill: "rgb(255, 255 ,255)", stroke: "rgb(15, 76, 129)", strokeWidth:  5, strokeJoin: "round", strokeCap: "square" },
    ...
    myDiagram.linkTemplate =
      ...
      myDiagram.addDiagramListener("ObjectSingleClicked", function(e) {
        // 전역변수 head에 저장(useGoDiagramWorkflow에서 정의)
  ...
  methods: {
    ...
    checkCur() {
      // 전역변수 head사용(useGoDiagramWo..정의)
      // 차후에 db로 요청보낸뒤 받아서 사용해야 함
